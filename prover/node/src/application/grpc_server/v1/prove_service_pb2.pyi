...
class UpdateVerifierRequest(_message.Message):
    __slots__ = ("proof_hash", "verifier")
    PROOF_HASH_FIELD_NUMBER: _ClassVar[int]
    VERIFIER_FIELD_NUMBER: _ClassVar[int]
    proof_hash: str
    verifier: str
    def __init__(self, proof_hash: _Optional[str] = ..., verifier: _Optional[str] = ...) -> None: ...
...
class ProveRequest(_message.Message):
    __slots__ = ("base_request", "method", "oauth_provider", "proof_hash")
    ...
    oauth_provider: str
    proof_hash: str
    def __init__(self, base_request: _Optional[_Union[ProveBaseRequest, _Mapping]] = ..., method: _Optional[int] = ..., oauth_provider: _Optional[str] = ..., proof_hash: _Optional[str] = ...) -> None: ...
...
class ProveOffchainRequest(_message.Message):
    __slots__ = ("base_request", "method", "oauth_provider", "proof_hash")
    BASE_REQUEST_FIELD_NUMBER: _ClassVar[int]
    METHOD_FIELD_NUMBER: _ClassVar[int]
    OAUTH_PROVIDER_FIELD_NUMBER: _ClassVar[int]
...
class ProveNosha256Request(_message.Message):
    __slots__ = ("base_request", "length", "method", "oauth_provider", "proof_hash")
    BASE_REQUEST_FIELD_NUMBER: _ClassVar[int]
    ...
    oauth_provider: str
    proof_hash: str
    def __init__(self, base_request: _Optional[_Union[ProveBaseRequest, _Mapping]] = ..., length: _Optional[int] = ..., method: _Optional[int] = ..., oauth_provider: _Optional[str] = ..., proof_hash: _Optional[str] = ...) -> None: ...
...
class UpdateVerifierResponse(_message.Message):
    __slots__ = ("base_response",)
    BASE_RESPONSE_FIELD_NUMBER: _ClassVar[int]
    base_response: StatusResponse
    def __init__(self, base_response: _Optional[_Union[StatusResponse, _Mapping]] = ...) -> None: ...
...
class ProveOffchainResponse(_message.Message):
    __slots__ = ("base_response", "proof_data", "witness_data")
    BASE_RESPONSE_FIELD_NUMBER: _ClassVar[int]
    PROOF_DATA_FIELD_NUMBER: _ClassVar[int]
    WITNESS_DATA_FIELD_NUMBER: _ClassVar[int]
